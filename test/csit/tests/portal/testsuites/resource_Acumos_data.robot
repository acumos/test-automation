...
#Acumos Configurations
 ...
 ${FF_PROFILE}                 D:/mr00561092/TECHM/FirefoxProfile
#Acumos Data
 ${username}                  Manisha              
 ${password}                  Manisha@123    
# ${SearchModelName_Public}      CrossSell_17122  
${SearchModelName_Public}      PUB_0422_IST   #Should be unpublished
${SearchModelName_Company}     COM_0422_IST    #Should be unpublished
${DeleteModelName}             DEL_0422_IST   #Should be unpublished
${SearchModelName_MyModel}     GEN_0422_IST    #GEN_07132018_WEM    #Should be unpublished
${SearchModelName_Error}       ERR_0422_IST
