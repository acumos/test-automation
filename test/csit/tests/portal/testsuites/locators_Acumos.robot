...
${check_Image_loaded}      //div[@class='grid-outer-wrapper']/div[1]/div[1]//div[1]/div[1]/div[1]/figure/img[@class='img-rounded']
...
${manageAuthors}        //a[contains(@ng-click,'Manage Authors')] 
...
${check_Image_loaded_COM}    //div[@ng-if='hideCompany']/div[1]/div[1]/div[@class='grid-top-section']/div/figure/img[@class='img-rounded']
...
${authorCreated}    //*[@id='Authors']/tags-input/div/div[@class='tags']/ul/li[1]
...
${requestorStatus}        //publish-request//tbody/tr[1]/td[5]/label 
...
${selectTag}            //div[@class='md-dialog-content']//div[@class='theme-tile-wrapper']/div[@class='theme-tile'][1]/div[@class='theme-check-container']/md-checkbox[1]/div/div[@class='md-icon']
...
${continueBtn_InterestsPopup}     //button[@title='Continue']
