...
${ModelCategory_Done_Public}     //button[contains(@ng-click,'updateSolution(); showSolCat = !showSolCat')]
...
${Catalog_Ist_TEST}    //div[@class='md-text'][contains(text(),'CATALOG_IST_TEST (Public)')]
...
${Catalog_Name}    //th[@ng-click="orderByField='name'; reverseSortcatalog = !reverseSortcatalog"]
${Publisher_Name}    //th[@ng-click="orderByField='publisher'; reverseSortcatalog = !reverseSortcatalog"]
${CreatedDate_Catalog}    //th[@ng-click="orderByField='created'; reverseSortcatalog = !reverseSortcatalog"]
${AccessType_Catalog}    //th[@ng-click="orderByField='accessTypeCode'; reverseSortcatalog = !reverseSortcatalog"]
${Total_Models}    //th[@ng-click="orderByField='solutionCount'; reverseSortcatalog = !reverseSortcatalog"]
${Action_Catalog}    //th[contains(text(),'ACTION')]
${AddNew_Catalog}    //button[contains(@title,'Add New Catalog')]
${AddNew_Catalog_PopUp}    //h2[contains(text(),'Add New Catalog')]
${CatalogName_Text}    //input[@name='catalogName']    
...
${searchCatalogTxtbox}    //input[@placeholder='Search Catalog by name']
...
${discover_Onborading}    (//div/market-home/section/div[3]/div[5]/div[2]/h5)[1]  #//main[@class='mdl-layout__content initialVal ']//section//div[@class='discover']/div/div[@class='discover-description']/h5[contains(text(),'Onboard with your Preferred Toolkit')]
...
${select_MLP_SystemUser}    (//div[@class='md-text'][contains(.,'MLP System User')])[3]  #(//md-option[contains(@ng-repeat,'role in allRoles')])[4]  #//div[text()='MLP System User']//ancestor::div[contains(@class,"md-active")]//following-sibling::div[text()='MLP System User']/preceding-sibling::div[@class='md-container']//div[@class='md-icon']
