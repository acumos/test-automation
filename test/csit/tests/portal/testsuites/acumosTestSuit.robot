...
To verify previous is disabled when page load and when page end next is disabled
     ...
     Wait Until Element Is Visible    ${Page_1_Btn}    20s
     Element Should Be Visible    ${Page_1_Btn}
     Wait Until Element Is Visible    ${PreviousBtn}    20s
     Element Should Be Visible    ${PreviousBtn} 

To verify ellipsis click functionality     
     Wait Until Keyword Succeeds  60   10    Wait Until Element Is Not Visible    ${overlay}    10s
     Wait Until Element Is Visible    ${ellipsisBtn}    20s
     Element Should Be Visible    ${ellipsisBtn}
     Click Button    ${ellipsisBtn}
     Wait Until Element Is Visible    ${nextBtn}    20s
...
Verify category is displaying for model except unpublished status
	 ...
	 Wait Until Element Is Visible    ${Category_link}    20s
...
Verify signature is displaying on model description screen for composite solution
     ...
     sleep    10s
     Wait Until Keyword Succeeds  60   10    Wait Until Element Is Visible    ${check_Image_loaded_PUBa}     20s
	 ...
	 Wait Until Element Is Visible    ${signaturesTitle}    15s
...
Verify long comment is displaying on click of view
	 ...
	 Wait Until Keyword Succeeds  60   10    Wait Until Element Is Visible    ${Approved_Text}    60s
...
Verify complete model name display in the rate section on model description screen
	 ...
	 Input Text    ${searchModelTxtbox}    ${SearchModelName_Public}
	 Wait Until Keyword Succeeds  60   5    Element Text Should Be     ${imageToVerify_P}    ${SearchModelName_Public}
	 Wait Until Keyword Succeeds  60   5    Wait Until Element Is Visible    ${check_Image_loaded_PUBa}     60s
	 Click Element    ${check_Image_loaded_PUBa}
...
Verify the Status of Deleted solution in Model details page
	 ...
	 Wait Until Keyword Succeeds  60   10    Wait Until Element Is Not Visible    ${overlay}    30s
	 sleep    10s
	 Wait Until Keyword Succeeds  60   10    Wait Until Element Is Visible    ${check_Image_loaded_DELa}    30s
...
Verify adding new user in User Management and User Activation
     ...
     # Page Should Contain    ${AddnewUser_Popup}        
     sleep    20s
